...
def solve(n, d1, d2):
  ...
  dp = [[[[-1 for _ in range(n+1)] for _ in range(n+1)] for _ in range(2)] for _ in range(2)]
  fr = [[[[-1 for _ in range(n+1)] for _ in range(n+1)] for _ in range(2)] for _ in range(2)]
